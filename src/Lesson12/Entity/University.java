...
import Lesson12.Exceptions.DepartmentNotFoundException;
import Lesson12.Exceptions.MentorNotFoundException;
...
public class University {
    ...
    HashMap<String, ArrayList<Mentor>> studentAndMentor = new HashMap<String, ArrayList<Mentor>>();
    ...
    public void getStudentsAndMentorsMap(){
        for (Student student : studentList){
            studentAndMentor.put(student.getName(), student.getDepartment().getMentors());
        }

        System.out.println("__________________________");

        System.out.println("Список студентов и преподавателей выведенный через карту:");

        for (Map.Entry<String, ArrayList<Mentor>> entry : studentAndMentor.entrySet()){
